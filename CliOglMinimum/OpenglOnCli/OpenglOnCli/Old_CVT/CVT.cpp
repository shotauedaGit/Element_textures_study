...
void CVT::Init(float w, float h, int n) { //母点の列と巨大３角形を生成 todo Note that Randomize()
	nV = n;
...
void CVT::Randomize() {//isFinishedを初期化している
	...
	*/
	...
	cout << "[Randomize] resize and assign" << endl;
	...
	cout << "[Randomize] make wall done" << endl;
...
void CVT::IterStep() {// step by step 使用作っとく？？
	...
	*/
	...
	InitTriangleVector();
	cout << "CVT::InitTriangle"<<"  itercnt::"<<iterCnt << endl;
	DelaunayTrianglaion();
	cout << "CVT::Triangulation Done" << "  itercnt::" << iterCnt << endl;
	VCpoints = CentroidVoronoi();
	cout << "CVT::Centroid calclated" << "  itercnt::" << iterCnt << endl;
	AssignCentroid();
	cout << "CVT::Centroid assigned (as Point)" << "  itercnt::" << iterCnt << endl;
